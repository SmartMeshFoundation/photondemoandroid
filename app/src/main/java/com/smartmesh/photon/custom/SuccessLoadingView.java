...
public class SuccessLoadingView extends View {
	...
	private static final int DEFAULT_PAINT_COLOR = Color.parseColor("#45FFBF");
	...
	private void init(AttributeSet attrs) {
		...
		mStrokeColor = ta.getColor(R.styleable.SuccessLoadingView_strokeColorCustom, DEFAULT_PAINT_COLOR);
		mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SuccessLoadingView_strokeWidthCustom,
