package com.smartmesh.photon.language;
...
public class MultiLanguageUtil {
    ...
    private void setConfiguration() {
        ...
        Configuration configuration = PhotonApplication.mContext.getResources().getConfiguration();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            configuration.setLocale(targetLocale);
        } else {
            configuration.locale = targetLocale;
        }
        Resources resources = PhotonApplication.mContext.getResources();
    ...
    private Locale getLanguageLocale() {
        int languageType = MySharedPrefs.readInt(PhotonApplication.mContext,MySharedPrefs.FILE_APPLICATION,MySharedPrefs.KEY_SAVE_LANGUAGE);
    ...
    public void updateLanguage(int languageType,boolean writeSharedPrefs) {
        if (writeSharedPrefs){
            MySharedPrefs.writeInt(PhotonApplication.mContext,MySharedPrefs.FILE_APPLICATION,MySharedPrefs.KEY_SAVE_LANGUAGE,languageType);
        }
